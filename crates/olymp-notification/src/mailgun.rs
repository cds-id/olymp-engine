...
impl MailgunProvider {
    ...
    pub fn from_env() -> Result<Self, AppError> {
        let api_key = dotenvy::var("OLYMP__EMAIL__MAILGUN_API_KEY")
            .map_err(|_| AppError::Internal("OLYMP__EMAIL__MAILGUN_API_KEY not set".into()))?;
        let domain = dotenvy::var("OLYMP__EMAIL__MAILGUN_DOMAIN")
